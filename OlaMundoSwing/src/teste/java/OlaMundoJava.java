...
public class OlaMundoJava extends javax.swing.JFrame {
   ...
   * Creates new form OlaMundoJava
    ...
    private void initComponents() {
        ...
        btmclick.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btmclick.setText("Consulte o Idioma");
        btmclick.setActionCommand("Click em mim ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btmclick, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(13, 13, 13)
    ...
    private void btmclickActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmclickActionPerformed
        ...
        //txtLabel.setText("OOLAsdas\nfskjdnasljkfnals\nsfkhasbkjfa");
        txtLabel.setText(getDefault().getDisplayLanguage()+ "\n\n" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
